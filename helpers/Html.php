...
EOF;
    ...
    static public function jsDirtyForms()
    {
        ...
        publishJs(Yii::app()->theme->basePath . '/js/vendor/jquery.dirtyforms.js', CClientScript::POS_HEAD);
        publishJs(Yii::app()->theme->basePath . '/js/dirty-forms-ckeditor.js', CClientScript::POS_HEAD);
        ...
        publishJs(Yii::app()->theme->basePath . '/js/toggle-dirty-buttons.js', CClientScript::POS_READY); // show action buttons when form is dirty
    }
    ...
    {
        publishJs(Yii::app()->theme->basePath . '/js/vendor/facebox/facebox.js', CClientScript::POS_HEAD);
        publishCss(Yii::app()->theme->basePath . '/js/vendor/facebox/assets/facebox.css');
    ...
    /**
     * Creates a custom label for an CActiveRecord field with an attribute hint tooltip.
     ...
     */
    static public function attributeLabelWithTooltip(CActiveRecord $model, $attribute, $hintAttribute = '', $htmlOptions = array())
    {
